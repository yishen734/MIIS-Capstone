...
class Play extends Component {
  ...
  render() {
    ...
    const containerStyles = {
      ...
      cursor: 'pointer',
      userSelect: 'none',
      transition: !this.state.focus ? `all 750ms ${cubicBezier}` : `all 300ms ${cubicBezier}`,
      boxShadow,
    }
    ...
    return (
      ...
      >
        <svg className="PlayIcon" viewBox="0 0 80 80" style={iconStyle}>
          <path className="PlayFill" style={pathStyle} d="M29,68.3 29.5,22.5 60.3,40.8 37.4,56.1" />
          <path
            className="PlayBg"
            fill={fillColor}
